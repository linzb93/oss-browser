            ...
            >
                ...
                >
                    <el-table :data="ossList" @selection-change="handleSelectionChange">
                        <el-table-column
                            type="selection"
                            :selectable="(row: TableItem) => row.type !== 'dir'"
                            width="35"
                        />
...
import { batchCommand } from '@/renderer/helpers/batch';
import { isPic } from '@/renderer/helpers/picture';
import type { BatchCommandKey } from '@/renderer/helpers/batch';

import { TableItem } from '@/shared/types';

const { ossList, getOSSList, createDirectory } = useOSSStore();
